class UsersController < ApplicationController
  ...
  private
    ...
    def brand_params
      params.require(:brand).permit(:name, :phone_number, :website, {images:[]}, :email, :facebook, :twitter, :instagram, :logo, :tagline, :about, :payment_policy, :return_policy, :shipping_policy, :faq_policy, :other_policy, :is_wholesale)
    end
